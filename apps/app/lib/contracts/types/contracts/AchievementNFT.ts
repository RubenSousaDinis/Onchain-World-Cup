...
export declare namespace AchievementNFT {
  export type NFTMetadataStruct = { mintedAt: BigNumberish; data: string };

  export type NFTMetadataStructOutput = [mintedAt: bigint, data: string] & {
    mintedAt: bigint;
    data: string;
  };
}

export interface AchievementNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MINT_PRICE"
      | "approve"
...
export namespace NFTMintedEvent {
  ...
  export type OutputTuple = [user: string, tokenId: bigint, tokenURI: string];
  export interface OutputObject {
    user: string;
    tokenId: bigint;
    tokenURI: string;
...
export interface AchievementNFT extends BaseContract {
  connect(runner?: ContractRunner | null): AchievementNFT;
  waitForDeployment(): Promise<this>;

  interface: AchievementNFTInterface;
  ...
  getNFTMetadata: TypedContractMethod<
    [tokenId: BigNumberish],
    [AchievementNFT.NFTMetadataStructOutput],
    "view"
  >;
  ...
  nftMetadata: TypedContractMethod<
    [arg0: BigNumberish],
    [[bigint, string] & { mintedAt: bigint; data: string }],
    "view"
  >;
