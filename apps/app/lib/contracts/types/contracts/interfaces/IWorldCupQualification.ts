...
export interface IWorldCupQualificationInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BASE_PRICE"
...
export interface IWorldCupQualification extends BaseContract {
  connect(runner?: ContractRunner | null): IWorldCupQualification;
  waitForDeployment(): Promise<this>;

  interface: IWorldCupQualificationInterface;
  ...
  hasClaimed: TypedContractMethod<[voter: AddressLike], [boolean], "view">;
  ...
  validCountry: TypedContractMethod<[country: BytesLike], [boolean], "view">;
