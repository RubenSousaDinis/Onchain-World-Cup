...
export declare namespace MatchNFT {
...
export interface MatchNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface MatchNFT extends BaseContract {
  connect(runner?: ContractRunner | null): MatchNFT;
  waitForDeployment(): Promise<this>;

  interface: MatchNFTInterface;
  ...
  getNFTMetadata: TypedContractMethod<
    [tokenId: BigNumberish],
    [MatchNFT.NFTMetadataStructOutput],
    "view"
  >;
