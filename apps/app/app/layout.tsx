          ...
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <nav aria-label="Social" className="flex items-center gap-3">
                ...
                <a href="https://warpcast.com/onchainworldcup" target="_blank" rel="noopener noreferrer" aria-label="Follow on Farcaster" className="hover:text-foreground transition-colors">
