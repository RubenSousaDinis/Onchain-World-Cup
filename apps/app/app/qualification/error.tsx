...
export default function QualificationError({
  error,
  reset,
}: {
        ...
        <div className="cm-panel rounded-sm overflow-hidden">
          <div className="bg-red-500/20 border-b-2 border-red-500/30 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-red-400">Qualification Error</h1>
                <p className="text-sm text-foreground/70">Failed to load qualification data</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 space-y-4">
            <div className="bg-secondary/50 border border-border rounded-sm p-4">
              <p className="text-foreground/80">
                Unable to load the qualification leaderboard. The voting data may be temporarily unavailable.
              </p>
            </div>
            ...
            <div className="flex gap-3">
              <button
                onClick={reset}
                className="flex items-center gap-2 cm-button bg-accent/10 hover:bg-accent/20 border border-accent/30 px-4 py-3 rounded-sm transition-colors flex-1 justify-center"
              >
