      ...
      <main id="main-content" className="flex-1 lg:ml-24 p-4 lg:p-8 pb-20 lg:pb-8 max-w-full overflow-hidden">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4 mb-6 lg:mb-8">
          <StatCard
            ...
            value={`${fmtEth(totalETH)} ETH`}
            valueColor="accent"
          />
          <StatCard
            icon={TrendingUp}
            label="Prize Pool (90%)"
            value={`${fmtEth(totalETH * 0.9)} ETH`}
            valueColor="green"
          />
          <StatCard
            icon={Target}
          ...
          <StatCard
            ...
            value={`${fmtEth(averageVoteSize)} ETH`}
          />
          <StatCard
            icon={BarChart3}
            ...
            <div className="space-y-3">
              {summaryData?.top_countries && summaryData.top_countries.length > 0 ? (
                <>
                  ...
                  <StatRow
                    label="ETH Backing"
                    value={`${fmtEth(summaryData.top_countries[0].total_eth)} ETH`}
          ...
          <div className="cm-panel rounded-sm p-4 lg:p-6">
            ...
            <div className="space-y-3">
              ...
              <StatRow
                ...
                value={`${fmtEth(totalETH * 0.1)} ETH`}
                valueClass="text-accent"
              />
              <StatRow
                label="Avg per Country"
                value={`${summaryData?.total_countries ? fmtEth(totalETH / summaryData.total_countries) : '0'} ETH`}
                valueClass="text-green-500"
              />
            </div>
          </div>
