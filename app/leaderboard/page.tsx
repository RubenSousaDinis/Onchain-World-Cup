...
const mockLeaderboard = [
  { rank: 1, address: "0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D", totalWinnings: "45.8", totalBets: 23, winRate: 78 },
  { rank: 2, address: "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2", totalWinnings: "38.2", totalBets: 19, winRate: 74 },
  { rank: 3, address: "0xdAC17F958D2ee523a2206206994597C13D831ec7", totalWinnings: "32.5", totalBets: 17, winRate: 71 },
  { rank: 4, address: "0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599", totalWinnings: "28.9", totalBets: 15, winRate: 67 },
  { rank: 5, address: "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48", totalWinnings: "24.3", totalBets: 14, winRate: 64 },
  { rank: 6, address: "0x514910771AF9Ca656af840dff83E8264EcF986CA", totalWinnings: "21.7", totalBets: 12, winRate: 58 },
  { rank: 7, address: "0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE", totalWinnings: "19.2", totalBets: 11, winRate: 55 },
  { rank: 8, address: "0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984", totalWinnings: "16.8", totalBets: 10, winRate: 50 },
  { rank: 9, address: "0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9", totalWinnings: "14.5", totalBets: 9, winRate: 44 },
  { rank: 10, address: "0xC18360217D8F7Ab5e7c516566761Ea12Ce7F9D72", totalWinnings: "12.1", totalBets: 8, winRate: 38 },
]
      ...
      <main className="flex-1 lg:ml-24 p-4 lg:p-8 pb-20 lg:pb-8 max-w-full overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 mb-8 lg:mb-12">
          ...
          <div className="cm-panel rounded-sm p-4 lg:p-6 flex flex-col items-center border-2 border-primary/50 lg:order-2 bg-secondary/20">
            ...
            <div className="text-xs font-mono text-foreground mb-2 bg-card/50 px-2 py-1 rounded-sm">
            ...
            <div className="text-xs text-accent font-bold">{mockLeaderboard[0].winRate}% Win Rate</div>
            <div className="text-[10px] text-muted-foreground mt-2">{mockLeaderboard[0].totalBets} Total Bets</div>
          </div>
          ...
          <div className="cm-panel rounded-sm p-4 lg:p-6 flex flex-col items-center lg:justify-end lg:order-1 bg-secondary/10">
            ...
            <div className="text-xs text-accent font-bold">{mockLeaderboard[1].winRate}% Win Rate</div>
            <div className="text-[10px] text-muted-foreground mt-2">{mockLeaderboard[1].totalBets} Total Bets</div>
          </div>
          ...
          <div className="cm-panel rounded-sm p-4 lg:p-6 flex flex-col items-center lg:justify-end lg:order-3 bg-secondary/10">
            ...
            <div className="text-xs text-accent font-bold">{mockLeaderboard[2].winRate}% Win Rate</div>
            <div className="text-[10px] text-muted-foreground mt-2">{mockLeaderboard[2].totalBets} Total Bets</div>
          </div>
        </div>
                  ...
                  >
                    ...
                    <td className="px-3 lg:px-4 py-3">
                      <Link
                        ...
                        className="text-xs lg:text-sm font-mono text-foreground hover:text-primary transition-colors font-bold"
                      >
                    ...
                    <td className="px-3 lg:px-4 py-3 text-right">
                      <span className="text-xs lg:text-sm font-mono text-foreground font-bold">{entry.totalBets}</span>
                    </td>
                    <td className="px-3 lg:px-4 py-3 text-right">
